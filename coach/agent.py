...
- Ouput should not be too long or verbose — aim for concise, specific advice that fits in a Telegram message. If the answer is long, summarise key points at the top.
